...
main_kb = types.ReplyKeyboardMarkup(keyboard=[
    ...
    [types.KeyboardButton(text="✍️ Тренировка"), types.KeyboardButton(text="🌐 Наш сайт", web_app=WebAppInfo(url="https://vk.link/punctle"))],
...
@dp.message(lambda m: m.text == "👤 Авторы")
